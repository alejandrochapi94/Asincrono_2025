...
// Nueva ruta para devolver el enlace de redirección
app.get('/get-p2-link', validateToken, (req, res) => {
  // Devuelve el enlace a p2.html como un objeto JSON
  res.json({ redirectUrl: '/p2' });
});
